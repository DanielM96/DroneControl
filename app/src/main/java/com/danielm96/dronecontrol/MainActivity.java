 ...
 * MainActivity
 * <p>
 * Tu znajduje się główny panel sterowania dronem.
 * <p>
 * Na początku aplikacja sprawdza stan uprawnień.
 * <p>
 * Następnie, jeśli wszystko jest w porządku, uruchamiana jest właściwa część activity (wywołanie metody startApp()).
 */
...
public class MainActivity extends AppCompatActivity {
    ...
    public static class ClientTask extends AsyncTask<String, Void, String> {
        ...
        // Działania asynchroniczne wykonywane w tle
        @Override
